...
/*
Ler um caractere maiúsculo, que indica uma operação que deve ser realizada e
...
conforme ilustrado abaixo (área verde).Arquivo em assets area-inferior.png
...
que compõem a matriz. Logo imprima o resultado solicitado (a soma ou média), 
